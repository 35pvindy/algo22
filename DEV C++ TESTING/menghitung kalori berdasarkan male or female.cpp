...
int main(){
	...
	cout<<"MASUKAN TINGI DALAM CM	:  ";
	cin>>tinggi;
	cout<<"MASUKAN BERAT DALAM KG	:  ";
	cin>>berat;
	cout<<"MASUKAN USIA	:  ";
	cin>>usia;
	
//	switch (sex){
//		case 1 : BMR = 66 + (13.7 * berat) + (5 * tinggi) - (6.8 - usia); break;
//		case 2 : BMR = 655 + (9.6 * berat) + (1.8 * tinggi) - (4,7 - usia); break;
//		
//	}
	if (sex == 1){
	...
	cout<<"Kebutuhan kalori tiap harinya adalah : 	"<<cal<<" kalori."<<endl;
